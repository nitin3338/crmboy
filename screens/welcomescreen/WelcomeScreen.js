    ...
    <View style={styles.container}>
      ...
      <ScrollView showsHorizontalScrollIndicator={false}>
        <View style={[styles.mt3]}>
          ...
          <Text style={[styles.headingMedium, styles.centered, styles.mt11]}>
            WELCOME
          </Text>
          <Text
            style={[
          ...
          >
            Streamlining Your Business With Powered Cloud Solutions
          </Text>
        </View>
      </ScrollView>
      <View style={styles.centered}>
        <TouchableOpacity style={[ styles.btn, styles.btnPrimary, styles.btnSquare70, styles.btnCircle]}
